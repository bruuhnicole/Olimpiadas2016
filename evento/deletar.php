...
<body>
     <h1> Exclusão de evento - RIO 2016</h1>      
    ...
    <form method="post">
        ...
        <fieldset>
            ...
            <table cellspacing="15">
                <tr>
                    <td>
                        <label fo="cod">Código:</label>
                    </td>
                    <td align="left">
                        <input for="text" name="cod" maxlength="4">
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <label fo="especifico">Especifico:</label>
                    </td>
                    <td align="left">
                        <input type="checkbox" name="especif">
                    </td>
                    
                    <td>
                        <input type="button" name="pesq" value="Pesquisar">
                    </td>
                </tr>
